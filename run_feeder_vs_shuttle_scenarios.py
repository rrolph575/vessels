...
# Define range of values for parameter sweeps
param_dict = {
    'site_position_time': [40, 35, 30, 25, 20, 15, 10, 5, 1]
}

#for i,f in enumerate(['shuttle_foreign_infreq_close.yaml', 'shuttle_foreign_infreq_far.yaml']):
def run_scenarios(num_turbines=num_turbines, library=LIBRARY, weather=WEATHER):
